...
q.setParameter("trans",t);
	...
	@Override
	public double somaPrecosPacotesPorTransporte(Transporte transporte) {
		// TODO Auto-generated method stub
		return em.createQuery("select sum(p.preco) from Pacote p where p.transporte = :t",Double.class).setParameter("t",transporte).getSingleResult();
	}
